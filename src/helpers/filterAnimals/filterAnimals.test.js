...
describe('filterAnimals tests', () => {
  ...
  it('Should return an object', () => {
    expect(typeof filterAnimals('a', mockAnimalsArray, 'name')).toEqual(
      'object'
    );
  });
  ...
  it('Should should change an animals display property based on the input value', () => {
    ...
    const mockFilteredAnimals = filterAnimals('fox', mockAnimalsArray, 'name');
  ...
  it('Should set all display properties to false if no animals match the input value', () => {
    const mockFilteredAnimals = filterAnimals(
      'whale',
      mockAnimalsArray,
      'name'
    );
